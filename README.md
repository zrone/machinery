...
[![godoc for RichardKnop/machinery](https://godoc.org/github.com/nathany/looper?status.svg)](http://godoc.org/github.com/zrone/machinery/v1)
...
[![Go Report Card](https://goreportcard.com/badge/github.com/zrone/machinery)](https://goreportcard.com/report/github.com/zrone/machinery)
[![GolangCI](https://golangci.com/badges/github.com/zrone/machinery.svg)](https://golangci.com)
[![OpenTracing Badge](https://img.shields.io/badge/OpenTracing-enabled-blue.svg)](http://opentracing.io)

[![Sourcegraph for RichardKnop/machinery](https://sourcegraph.com/github.com/zrone/machinery/-/badge.svg)](https://sourcegraph.com/github.com/zrone/machinery?badge)
...
```go
import (
  "github.com/zrone/machinery/v2"
  backendsiface "github.com/zrone/machinery/v2/backends/iface"
  brokersiface "github.com/zrone/machinery/v2/brokers/iface"
  locksiface "github.com/zrone/machinery/v2/locks/iface"
)
...
```sh
go get github.com/zrone/machinery/v1
```

Or to get experimental v2 release:

```sh
go get github.com/zrone/machinery/v2
```
...
> Keep in mind AMQP is not recommended as a result backend. See [Keeping Results](https://github.com/zrone/machinery#keeping-results)
...
Then just set the logger in your setup code by calling `Set` function exported by `github.com/zrone/machinery/v1/log` package:
...
```go
import (
  "github.com/zrone/machinery/v1/config"
  "github.com/zrone/machinery/v1"
)
...
```go
import (
  "github.com/zrone/machinery/v1/tasks"
)
